...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">my_team</span> <span class="o">=</span> <span class="p">[</span><span class="s2">&quot;Jake&quot;</span><span class="p">,</span> <span class="s2">&quot;Finn&quot;</span><span class="p">,</span> <span class="s2">&quot;Kush&quot;</span><span class="p">,</span> <span class="s2">&quot;James&quot;</span><span class="p">,</span> <span class="s2">&quot;Gene&quot;</span><span class="p">,</span> <span class="s2">&quot;Zeen&quot;</span><span class="p">,</span> <span class="s2">&quot;Ediwn&quot;</span><span class="p">]</span>
<span class="n">my_team</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="s2">&quot;Luka&quot;</span><span class="p">)</span>
<span class="n">my_team</span><span class="o">.</span><span class="n">remove</span><span class="p">(</span><span class="s2">&quot;Jake&quot;</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="n">my_team</span><span class="p">)</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>[&#39;Finn&#39;, &#39;Kush&#39;, &#39;James&#39;, &#39;Gene&#39;, &#39;Zeen&#39;, &#39;Ediwn&#39;, &#39;Luka&#39;]
</pre>
</div>
</div>
...
<li>The while keeps looping until the condintion give is met or not true<ul>
<li>I have two list and varibles so each time it loops over it picks the next value in both list</li>
</ul>
</li>
<li>the for loops just loops for the amount of things inside<ul>
<li>It does a simlar thing but just needs one varible to cycle through the days</li>
</ul>
</li>
</ul>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">week</span> <span class="o">=</span> <span class="p">[</span><span class="s2">&quot;Push&quot;</span><span class="p">,</span> <span class="s2">&quot;Pull&quot;</span><span class="p">,</span> <span class="s2">&quot;Wrestling&quot;</span><span class="p">,</span> <span class="s2">&quot;Wrestling&quot;</span><span class="p">,</span> <span class="s2">&quot;Wrestling&quot;</span><span class="p">,</span> <span class="s2">&quot;Legs&quot;</span><span class="p">,</span> <span class="s2">&quot;Pull&quot;</span><span class="p">]</span>
<span class="n">week_days</span> <span class="o">=</span> <span class="p">[</span><span class="s2">&quot;Monday&quot;</span><span class="p">,</span> <span class="s2">&quot;Tuesday&quot;</span><span class="p">,</span> <span class="s2">&quot;Wednesday&quot;</span><span class="p">,</span> <span class="s2">&quot;Thursday&quot;</span><span class="p">,</span> <span class="s2">&quot;Friday&quot;</span><span class="p">,</span> <span class="s2">&quot;Saturday&quot;</span><span class="p">,</span> <span class="s2">&quot;Sunday&quot;</span><span class="p">]</span>
...
<span class="k">while</span> <span class="n">i</span> <span class="o">&lt;=</span> <span class="mi">7</span><span class="p">:</span>
    <span class="n">d</span> <span class="o">=</span> <span class="n">week</span><span class="p">[</span><span class="n">f</span><span class="p">]</span>
    <span class="n">e</span> <span class="o">=</span> <span class="n">week_days</span><span class="p">[</span><span class="n">f</span><span class="p">]</span>
    <span class="nb">print</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Today is </span><span class="si">{</span><span class="n">e</span><span class="si">}</span><span class="s2"> and you have to do </span><span class="si">{</span><span class="n">d</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">)</span>
...
<span class="k">for</span> <span class="n">days</span> <span class="ow">in</span> <span class="n">week</span><span class="p">:</span>
    <span class="n">dayweek</span> <span class="o">=</span> <span class="n">week_days</span><span class="p">[</span><span class="n">z</span><span class="p">]</span>
    <span class="nb">print</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Today is </span><span class="si">{</span><span class="n">dayweek</span><span class="si">}</span><span class="s2"> and you have to do </span><span class="si">{</span><span class="n">days</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">)</span>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Today is Monday and you have to do Push
Today is Tuesday and you have to do Pull
Today is Wednesday and you have to do Wrestling
Today is Thursday and you have to do Wrestling
Today is Friday and you have to do Wrestling
Today is Saturday and you have to do Legs
Today is Sunday and you have to do Pull

Today is Monday and you have to do Push
Today is Tuesday and you have to do Pull
Today is Wednesday and you have to do Wrestling
Today is Thursday and you have to do Wrestling
Today is Friday and you have to do Wrestling
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h3 id="List-Hacks">List Hacks<a class="anchor-link" href="#List-Hacks"> </a></h3>
</div>
</div>
</div>
    {% raw %}
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="Dictonary-Hacks">Dictonary Hacks<a class="anchor-link" href="#Dictonary-Hacks"> </a></h2>
</div>
</div>
</div>
    {% raw %}
...
<span class="nb">dict</span> <span class="o">=</span> <span class="p">{</span>
    ...
    <span class="s2">&quot;key4&quot;</span><span class="p">:</span> <span class="s2">&quot;value4&quot;</span>
<span class="p">}</span>


<span class="k">def</span> <span class="nf">update_dict_table</span><span class="p">():</span>
    <span class="n">os</span><span class="o">.</span><span class="n">system</span><span class="p">(</span><span class="s2">&quot;clear&quot;</span> <span class="k">if</span> <span class="n">os</span><span class="o">.</span><span class="n">name</span> <span class="o">==</span> <span class="s2">&quot;posix&quot;</span> <span class="k">else</span> <span class="s2">&quot;cls&quot;</span><span class="p">)</span>
    <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Dictionaries</span><span class="se">\n</span><span class="s2">&quot;</span><span class="p">)</span>
    <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;Key               Value</span><span class="se">\n</span><span class="s2">&quot;</span><span class="p">)</span>
    <span class="k">for</span> <span class="n">key</span><span class="p">,</span> <span class="n">value</span> <span class="ow">in</span> <span class="nb">dict</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
        <span class="nb">print</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;</span><span class="si">{</span><span class="n">key</span><span class="o">.</span><span class="n">ljust</span><span class="p">(</span><span class="mi">18</span><span class="p">)</span><span class="si">}{</span><span class="n">value</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">)</span>
    <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;</span><span class="se">\n</span><span class="s2">What would you like to do?&quot;</span><span class="p">)</span>
    <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;1. Add a key-value pair&quot;</span><span class="p">)</span>
    <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;2. Remove a key-value pair&quot;</span><span class="p">)</span>
    <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;3. Quit&quot;</span><span class="p">)</span>


<span class="k">def</span> <span class="nf">add_dict_pair</span><span class="p">():</span>
    ...
    <span class="n">value</span> <span class="o">=</span> <span class="nb">input</span><span class="p">(</span><span class="s2">&quot;Enter the value: &quot;</span><span class="p">)</span>
    <span class="k">if</span> <span class="n">key</span> <span class="ow">and</span> <span class="n">value</span> <span class="ow">and</span> <span class="n">key</span> <span class="ow">not</span> <span class="ow">in</span> <span class="nb">dict</span><span class="p">:</span>
...
<span class="k">def</span> <span class="nf">remove_dict_pair</span><span class="p">():</span>
    <span class="n">key</span> <span class="o">=</span> <span class="nb">input</span><span class="p">(</span><span class="s2">&quot;Enter the key to remove: &quot;</span><span class="p">)</span>
    <span class="k">if</span> <span class="n">key</span> <span class="ow">in</span> <span class="nb">dict</span><span class="p">:</span>
        <span class="k">del</span> <span class="nb">dict</span><span class="p">[</span><span class="n">key</span><span class="p">]</span>


<span class="k">def</span> <span class="nf">process_user_choice</span><span class="p">():</span>
    ...
    <span class="n">update_dict_table</span><span class="p">()</span>
    <span class="n">process_user_choice</span><span class="p">()</span>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="2D-Array-Hacks">2D-Array Hacks<a class="anchor-link" href="#2D-Array-Hacks"> </a></h2>
</div>
</div>
</div>
    {% raw %}
...
<span class="k">def</span> <span class="nf">draw_array</span><span class="p">():</span>
...
<img src="data:image/png;base64,"
>
</div>
